...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\alteracao_atibaia.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\alteracao_cruzeiro.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\alteracao_taubate.csv'
with (
format csv,
header true,
delimiter ';',
...
copy tbaoi_atibaia
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\aoi_atibaia.csv'
with (
format csv,
header true,
delimiter ';',
...
copy tbaoi_cruzeiro
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\aoi_cruzeiro.csv'
with (
format csv,
header true,
delimiter ';',
...
copy tbaoi_taubate
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\aoi_taubate.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\apontamento_alteracao_atibaia.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\apontamento_alteracao_cruzeiro.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\apontamento_alteracao_taubate.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\grade_atuacao_atibaia.csv'
with (format csv,
header true,
delimiter ';',
null 'NULL',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\grade_atuacao_cruzeiro.csv'
with (
format csv,
header true,
delimiter ';',
...
from 'C:\Users\caiqu\Desktop\fatec\abp-2024\back\Dados_Cliente\grade_atuacao_taubate.csv'
with (
format csv,
header true,
delimiter ';',
